...
namespace VRStandardAssets.Menu
{
    ...
    public class MenuAnimator : MonoBehaviour
    {
        ...
        [SerializeField] private InteractiveItem m_InteractiveItem; // The InteractiveItem that needs to be looked at for the textures to play.
        ...
        {
            // When the user looks at the InteractiveItem the textures should start playing.
            m_Playing = true;
        ...
        {
            // When the user looks away from the InteractiveItem the textures should no longer be playing.
            m_Playing = false;
        }
